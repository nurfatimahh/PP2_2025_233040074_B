...
public class Kalkulator {
    public static void main(String[] args) {
        ...
        //2. Membuat Layar dibagian atas mengggunakan JTextField
        JTextField layar = new JTextField();
        frame.add(layar, BorderLayout.NORTH);
        
        //3. Membuat panel untuk tombol dengan GridLayout 4 baris, 4kolom
        ...
        //5. Tambahkan panel ke frame di bagain CENTER
